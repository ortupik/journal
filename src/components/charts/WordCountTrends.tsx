...
const WordCountTrends = ({ data }: Props) => {
  ...
  return (
    <Card className='col-span-1'>
      <CardHeader>
        <CardTitle className='mb-4 text-center text-lg font-bold'>
          Word Count Trends
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className='mb-4 grid grid-cols-3 gap-2 text-center'>
          ...
          <div>
            <p className='text-muted-foreground text-xs'>Avg Words/Entry</p>
            <p className='font-bold'>{averageWordCount.toFixed(1)}</p>
          </div>
          <div>
            <p className='text-muted-foreground text-xs'>Peak Entry</p>
